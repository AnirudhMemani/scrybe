        ...
        <DropdownMenu>
            ...
            <DropdownMenuContent className="w-56" align="end" forceMount>
                ...
                <DropdownMenuItem asChild>
                    <a href="https://docs.scrybe.chat" target="_blank" rel="noopener noreferrer">
                ...
                <DropdownMenuItem asChild>
                    <a
                        href="https://github.com/AnirudhMemani/scrybe"
                        target="_blank"
                ...
                <DropdownMenuItem asChild>
                    <a href="https://x.com/scrybe" target="_blank" rel="noopener noreferrer">
