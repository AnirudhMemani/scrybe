...
export function LogoMark({ className }: { className?: string }) {
    return (
        ...
        >
            <g fill="currentColor">
                {/* s */}
                <rect x="20" y="18" width="60" height="12" rx="3" />
                <rect x="68" y="18" width="12" height="30" rx="3" />
                <rect x="32" y="48" width="48" height="12" rx="3" />
                <rect x="20" y="48" width="12" height="30" rx="3" />
                <rect x="20" y="78" width="60" height="12" rx="3" />

                {/* c */}
                <rect x="110" y="18" width="60" height="12" rx="3" />
                <rect x="110" y="18" width="12" height="72" rx="3" />
                <rect x="110" y="78" width="60" height="12" rx="3" />

                {/* r */}
                <rect x="200" y="18" width="12" height="72" rx="3" />
                <rect x="212" y="18" width="28" height="12" rx="3" />
                <rect x="212" y="48" width="22" height="12" rx="3" />
                <rect x="236" y="54" width="12" height="24" rx="3" />

                {/* y (uppercase-style) */}
                <rect x="280" y="18" width="12" height="36" rx="3" />
                <rect x="322" y="18" width="12" height="36" rx="3" />
                <rect x="292" y="36" width="28" height="12" rx="3" />
                <rect x="304" y="48" width="12" height="42" rx="3" />

                {/* b */}
                <rect x="360" y="18" width="12" height="72" rx="3" />
                <rect x="372" y="18" width="42" height="12" rx="3" />
                <rect x="402" y="18" width="12" height="30" rx="3" />
                <rect x="372" y="48" width="30" height="12" rx="3" />
                <rect x="402" y="48" width="12" height="30" rx="3" />
                <rect x="372" y="78" width="42" height="12" rx="3" />

                {/* e */}
                <rect x="440" y="18" width="12" height="72" rx="3" />
                <rect x="452" y="18" width="60" height="12" rx="3" />
                <rect x="452" y="48" width="48" height="12" rx="3" />
                <rect x="452" y="78" width="60" height="12" rx="3" />
            </g>
        </svg>
    )
}
