...
const SITE_TITLE = "scrybe.chat"
const SITE_DESCRIPTION = "Powerful AI chatbot. By scrybe, for scrybe."
const SITE_URL = "https://scrybe.chat" // Update this to your actual domain
